    ...
    <div class="login-box">
      ...
      <form class="login-form" action="<?php echo base_url()?>user/users">
        ...
        <div class="form-group btn-container">
          <button type="button" id="btn_login" class="btn btn-primary btn-block"><i class="fa fa-sign-in fa-lg fa-fw"></i>SIGN IN</button>
        </div>
      </form>
  ...
  <script type="text/javascript">
    $(document).ready(function(){
      $("#btn_login").click(function(){
        ...
        var ajaxReq = $.ajax({
          url: '<?php echo base_url()?>user/admin_login',
          type: 'POST',
          processData: false,
          contentType: false,
          data: formdata,
